...
<input type="text" class="form-control form-control-lg" name="referencee" placeholder="reference" aria-label="Username" onblur="verifname(this)">
</div>
<div class="form-group">
<label>nomcat</label>
<input type="text" class="form-control" placeholder="nom" name="nomcat" aria-label="Username" onblur="verifname(this)">
</div>
