...
<h4 class="card-title">Here are the details of the Delivery you are searching for:</h4>
</div>
...
if (isset($_GET["s"]) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT id_livraison,id_livreur,id_commande,adresse,ville,code_postal FROM livraison WHERE id_livraison LIKE ? ");
...
#columns:hover figure:not(:hover) {
 ...
 <body>
  <h2>Here are the details of the Delivery you are searching for:</h2>
  <?php
...
<div class="element" id="columns" >
 <figure>
   <div class="text-muted"><?php echo "ID Delivery: " ?><?php echo $terme_trouve['id_livraison']; ?></div></br>
   <div class="text-muted"><?php echo "ID DeliveryMan: " ?><?php echo $terme_trouve ['id_livreur']; ?></div></br>
   <div class="text-muted"><?php echo "ID Order: " ?><?php echo $terme_trouve['id_commande']; ?></div> </br>
   <div class="text-muted"><?php echo "Adress: " ?><?php echo $terme_trouve['adresse']; ?></div></br>
   <div class="text-muted"><?php echo "City: " ?><?php echo $terme_trouve['ville']; ?></div></br>
   <div class="text-muted"><?php echo "Postal Code: " ?><?php echo $terme_trouve['code_postal']; ?></div>
