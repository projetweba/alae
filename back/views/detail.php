...
$listeCommandes=$Commande1C->afficherligne($_POST["id_ligne"]);
...
<input type="submit" value="Montrer 3 par page">
</form>
</div>
...
<thead>
<tr>
<td class="text-dark text-semibold">IDENTIFIANT</td>
<td class="text-dark text-semibold">IDENTIFIANT DU COMMANDE</td>
<td class="text-dark text-semibold">ID DU PRODUIT</td>
<td class="text-dark text-semibold">QUANTITIE</td>
