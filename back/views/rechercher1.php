...
if (isset($_GET["s"]) )
{
 ...
 if (isset($terme))
 {
  $select_terme = $bdd->prepare("SELECT id_commande, id_utilisateur,dateAchat,id_ligne,valide FROM commande WHERE id_commande LIKE ? ");
...
<div class="selected float-right">
                                        ...
                                        <form action = "rechercher.php" method = "get">
                                            <input type = "search" name = "terme" placeholder="l'id du commande">
...
<table border="1">
<tr>
<td>L'identifiant du commande:</td>
<td>L'identifiant du client</td>
<td>Date d'achat</td>
<td>Les produit achetes</td>
<td>Valide</td>
</tr>
...
<?php
  while($terme_trouve = $select_terme->fetch())
  {
  	  ?>
	<tr>
	<td><?php echo $terme_trouve['id_commande']; ?></td>
	<td><?php echo $terme_trouve['id_utilisateur']; ?></td>
	<td><?php echo $terme_trouve['dateAchat']; ?></td>
	<td><?php echo $terme_trouve['id_ligne']; ?></td>
	<td>
	<?PHP 
	if ($terme_trouve['valide']==null) 
		{echo '<a href="" class="badge badge-danger"> en cours';} 
	else if($terme_trouve['valide']==1)
		{echo '<a href="" class="badge badge-success"> Traité';} 
	else if($terme_trouve['valide']==2)
