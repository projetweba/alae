...
<h4 class="card-title">Here are the details of the Reservation you are searching for:</h4>
</div>
...
if (isset($_GET["s"]) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT id_reserv,product_name,categorie_name,quantite FROM reservation WHERE id_reserv LIKE ? ");
...
<div class="element" id="columns" >
 <figure>
   <div class="text-muted"><?php echo "ID Reservation: " ?><?php echo $terme_trouve['id_reserv']; ?></div></br>
   <div class="text-muted"><?php echo "Categorie Name: " ?><?php echo $terme_trouve['categorie_name']; ?></div> </br>
   <div class="text-muted"><?php echo "Product Name: " ?><?php echo $terme_trouve ['product_name']; ?></div></br>
   <div class="text-muted"><?php echo "Quantity: " ?><?php echo $terme_trouve['quantite']; ?></div>
