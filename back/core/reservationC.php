...
function afficherReservation ($reservation){
	...
	function ajouterReservation($reservation){
		$sql="insert into reservation(id_reserv,product_name,categorie_name,quantite,description) values (:id_reserv,:product_name,:categorie_name,:quantite,:description)";
