<?php 
include "C:/wamp64/www/projetweb/front/config1.php";
...
<html>
    <body>
        <div align="center">
         <a href="http://localhost/projetweb/front/views/confirmation.php?pseudo='.$pseudo.'&key='.$key.'">Confirmer votre compte</a>
        </div>
    </body>
</html>
';
