...
function afficherReservation ($reservation){
	...
	function ajouterReservation($reservation){
		$sql="insert into reservation(id_reserv,categorie_name,product_name,quantite,description) values (:id_reserv,:categorie_name,:product_name,:quantite,:description)";
