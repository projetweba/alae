...
$bdd = new PDO('mysql:host=127.0.0.1;dbname=zanimobd', 'root', '');
session_start();
...
{var_dump($_POST['modifier']);
 foreach ($user as $key ) {
    ...
    if ($_POST['pseudo']!=$key['pseudo'] AND $_POST['mail']!=$key['mail'] AND $_POST['mdp1']==$_POST['mdp2']) {
        # code...
 $pseudo=$_POST['pseudo'];
    $mail=$_POST['mail'];
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#">PAGES</a>
                                            <ul class="submenu">
                                                ...
                                                <a href="disconnect.php"><button class="button">log out</button></a>
                                            </ul>
                                        </li>
                    ...
                    <div class="col-lg-12">
                        <div class="checkout-wrapper">
                            <div id="faq" class="panel-group">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title"><span>2</span> <a data-toggle="collapse" data-parent="#faq" href="#my-account-2">Change your password and E-mail </a></h5>
                                    </div>
