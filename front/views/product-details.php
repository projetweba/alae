...
<div id="mySidenav" class="sidenav">
  <a href="afficherpanier.php" id="about">panier</a>
  <a href="afficherwishlist.php" id="blog">wishlist</a>
</div>
                                            ...
                                            <ul class="mega-menu">
                                                <li>
                                                    <ul>
														...
														<li><a href="afficherwishlist.php">wishlist</a></li>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-8 col-sm-8 col-7">
                            <div class="search-login-cart-wrapper">
                                ...
                                <div class="header-login same-style">
                                    <a href="logout.php"><i class="icon-user icons"></i></a>
                                </div>
...
<?php echo '<a href="javascript:window.print()">IMPRIMER </a>'; ?>
        ...
        <div class="col-lg-6 col-md-6">
                ...
                <div   class="product-price">
				  ...
				  <input type="hidden" value="<?php echo $item['prix'];?>" id="chiffre2" onkeyup="Calcule()">
				...
				TOTAL : <div id="total"></div>DT
                <div class="quality-wrapper mt-30 product-quantity">
                                
                            </div>
							<audio id="myAudio">
							  <source src="moneymoves.mp3" type="audio/mpeg">
							  Your browser does not support the audio element.
							</audio>
                            <div class="product-list-action">
                                <div class="product-list-action-left">
														<form method="POST" action="ajouterPanier.php">
														<input	type="number" min="1" max="5" value="2" name="qte" onkeyup="Calcule()" id="chiffre1">
														<input type="hidden" value="<?php echo $item['reference']; ?>" name="ref">
														<input type="hidden" value="<?php echo $_SESSION['id']; ?>" name="id_utilisateur">
                                                        <input type="submit" value="add to cart" class="submit btn-style" onclick="playAudio()">
														
														</form>

                                
														<form method="POST" action="ajouterWishlist.php">
														<input type="hidden" value="<?php echo $item['reference']; ?>" name="id_produit">
														<input type="hidden" value="<?php echo $_SESSION['id']; ?>" name="id_utilisateur">
                                                        <input type="submit" value="add to wishlist" class="submit btn-style" onclick="playAudio()">
														</form>
                                </div>
                            </div>
