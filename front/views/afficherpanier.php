		 ...
		 <div class="cart-main-area pt-95 pb-100">
            <div class="container">
				...
				foreach($listePaniers as $row){
					...
					<td class="product-name"><?PHP echo $item['prix']*$row['qte']; $prixtotale=$prixtotale+$item['prix']*$row['qte']; ?></td>
							...
							<div class="row">
                                <div class="col-lg-12">
                                    <div class="cart-shiping-update-wrapper">
										...
										PRIX TOTALE :<input type="number" value="<?php echo $prixtotale; ?>" readonly>
											...
											<form method="POST" action="validerpanier.php">
													...
													<input type="hidden" value="<?php echo $prixtotale ;?>" name="prixtotale">
											</form>
                                        </div>
