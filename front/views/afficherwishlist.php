                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-5">
                            <div class="logo pt-39">
                                <a href="index.html"><img alt="" src="assets/img/zanimo.png"></a>
                            </div>
                        </div>
        ...
        <div class="breadcrumb-area pt-95 pb-95 bg-img" style="background-image:url(assets/img/banner/banner-2.jpg);">
		 ...
		 <div class="cart-main-area pt-95 pb-100">
            <div class="container">
				...
				$listewishlists=$wishlist1C->afficherwishlists($_SESSION['id']);
				?>
				<table>
				<thead>
				<tr>
				...
				foreach($listewishlists as $row){
					...
					<td class="product-name"><?PHP echo $row['id_prod']; ?></td>
					<td class="product-quantity">
                        <?php echo "1";?>
                    </td>
					<td>
						<form method="POST" action="validerwishlist.php">
							...
							<input type="submit" value="ajouter au panier" name="validerwishlist">
                                ...
                                <div class="col-lg-12">
                                    <div class="cart-shiping-update-wrapper">
                                        <div class="cart-shiping-update">
                                            <a href="shop-page.php">Continue Shopping</a><br/>
											
                                        </div>
                                        <div class="cart-clear">
												<form method="POST" action="supprimerwishlist.php">
												<input type="hidden" value="<?php echo $_SESSION['id']; ?>" name="id_utilisateur">
													<input type="submit" value="suprimer tous les produit" name="supprimerwishlist">
												</form>
                                        </div>
                                    </div>
                                </div>
